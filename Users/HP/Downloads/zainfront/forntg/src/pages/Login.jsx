      ...
      <div style={{ position: 'relative' }}>
        ...
        <input
          ...
          style={{
            ...
            background: focused ? 'rgba(79,142,247,0.05)' : 'rgba(255,255,255,0.04)',
            color: 'var(--txt)',
            fontSize: 14,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        backgroundImage: `linear-gradient(rgba(79,142,247,.03) 1px, transparent 1px),
        ...
        <TiltCard>
          ...
          >
            ...
            <motion.div variants={stagger} initial="hidden" animate="visible">
              ...
              {/* Heading */}
              <motion.div variants={item} style={{ textAlign: 'center', marginBottom: 32 }}>
                <h1 style={{
                  fontSize: 26, fontWeight: 900, margin: '0 0 8px',
                  letterSpacing: -0.5, color: 'var(--txt)',
                }}>Welcome back</h1>
                <p style={{ fontSize: 14, color: 'var(--txt-4)', margin: 0 }}>
              ...
              <motion.div variants={item}>
                <form onSubmit={handleSubmit}>
                  <FloatingInput
                    ...
                    icon={MdEmail} required autoFocus
                  />
                  <FloatingInput
                  ...
                  <motion.button
                    type="submit"
                    disabled={loading}
                    whileHover={!loading ? { scale: 1.02, boxShadow: '0 0 32px rgba(79,142,247,0.5)' } : {}}
                    ...
                    style={{
                      ...
                      background: loading
                        ? 'rgba(79,142,247,0.4)'
                        : 'linear-gradient(135deg, #4F8EF7 0%, #6D44F8 100%)',
